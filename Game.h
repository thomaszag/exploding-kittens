...
public:
	// Name - Constructor
	// Desc - Runs the game
	// Preconditions - a valid constant that holds the name of the deck fil\
		e and bomb file
...
private:
	...
	// Postconditions - A deck with the elements shuffled in a different or\
			der
	void Shuffle();
	...
	// Preconditions - A deck with at least 1 card
	// Postconditions - Will print the next [insert const num] card(s) in t\
			he deck
   void Peek();
